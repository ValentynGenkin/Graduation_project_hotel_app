...
const BookingCart = () => {
  ...
  const cartItems = bookingContext.bookingDetails.map((bookingDetail) => {
      ...
      <div key={bookingDetail._id} className="cart-booking-detail">
        ...
        <p>
          ...
          {`${dayDiff} night(s) x ${
            ...
            dayDiff * parseFloat(bookingDetail.roomId.roomPrice.$numberDecimal)
          }`}
        </p>
      </div>
    );
  ...
  return (
    <div className="cart-container">
      <div className="cart-button">View Cart</div>
